 ...
 * @brief   Il seguente programma ha lo scopo di realizzare un server "centrale", il quale avrà lo scopo di gestire le richieste del server "centro vaccinale" ed "assistente"
 * 
 * @type    Eseguibile
 * @version 1.0
 */
...
#define SERVER_PORT 6464 /* Definiamo come costante la porta del server "centro vaccinale" in ascolto ed in attesa di accettare nuove connessioni */
